...
"""
            ...
            if first_test_mode == "spawn":
                ...
                print(f"- spawn: {'✓' if attach_result['status'] == 'success' else '✗'}")
                print(
                    f"- inject_user_script_run_all (after spawn): {'✓' if inject_result_attach['status'] == 'success' else '✗'}")
                print(f"- detach (after spawn): {'✓' if detach_result_attach['status'] == 'success' else '✗'}")
            else:  # first_test_mode == "attach"
                ...
                print(f"- attach: {'✓' if spawn_result['status'] == 'success' else '✗'}")
                print(
                    f"- inject_user_script_run_all (after attach): {'✓' if inject_result['status'] == 'success' else '✗'}")
                print(f"- detach (after attach): {'✓' if detach_result['status'] == 'success' else '✗'}")
